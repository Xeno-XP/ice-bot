...
module.exports = {
  ...
  async run (client, message, args, lang) {
    ...
    if (serverQueue && channel !== message.guild.me.voice.channel)
      return message.reply(`You must be in the same channel as ${client.user}`).catch(console.error);

    if (!args.length)
      return message
        .reply(`Usage: ${client.prefix}playlist <YouTube Playlist URL | Playlist Name>`)
        .catch(console.error);
